...
class build(Frame):
    ...
    def on_enter(self, event):
        self.l1.configure(text="1.1 | 16 June 2022")
...
root.bind("<Control-f>", getchecksum)
...
root.bind("<Control-g>", verifychecksum)
...
lbl5 = Label(text="Enter the checksum:", font=("Consolas", 15), bg="#25292e", fg="white", bd=0)
nopath = Label(text="Enter file's path:", font=("Consolas", 15), bg="#25292e", fg="red")
nochecksum = Label(text="Enter the checksum:", font=("Consolas", 15), bg="#25292e", fg="red")
